...
/* USER CODE END Boot_Mode_Sequence_2 */
  ...
  /*
	if(f_mount(&SDFatFS, (TCHAR const*)SDPath,0) == FR_OK){
			...
			uint8_t msg[] = "SDCard - mounted\r\n";
			HAL_UART_Transmit(&huart3, msg, strlen((char *)msg), HAL_MAX_DELAY);
	
			char myFileName[] = "TestSTM.txt";
		
			if(f_open(&SDFile, myFileName, FA_CREATE_ALWAYS | FA_WRITE) == FR_OK){
				
				uint8_t msg[] = "SDCard - file opened\r\n";
				HAL_UART_Transmit(&huart3, msg, strlen((char *)msg), HAL_MAX_DELAY);
			...
			uint8_t msg[] = "SDCard - not mounted\r\n";
			HAL_UART_Transmit(&huart3, msg, strlen((char *)msg), HAL_MAX_DELAY);
	}
  */
